 ...
 * [TwoFirstFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [TwoFirstFragment.newInstance] factory method to
...
class TwoFirstFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.plus_one_button.text = "two button_2"
        return view
    }
...
//            throw RuntimeException(context!!.toString() + " must implement OnFragmentInteractionListener")
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): TwoFirstFragment {
            val fragment = TwoFirstFragment()
            val args = Bundle()
